...
Point (1) = {5*D, 0.05*D + D/2, 0, size/500};
Point (2) = {5*D + D/2, 0.05*D + D/2, 0, size/500};
Point (3) = {5*D, 0.05*D + D, 0, size/500};
Point (4) = {5*D - D/2, 0.05*D + D/2, 0, size/500};
Point (5) = {5*D, 0.05*D, 0, size/500};
Point (6) = {0, 0, 0, size/25};
Point (7) = {5*D - D, 0, 0, size/500};
Point (8) = {5*D + D, 0, 0, size/500};
